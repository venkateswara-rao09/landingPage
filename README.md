...
📌 Fixed Navigation Bar — Navigation remains visible while scrolling through the page.

🎨 Interactive Hover Effects — Navigation links change color and display an animated underline when hovered.

🖱️ Scroll-Based Navigation — Navigation bar changes its background, size, and shadow when the user scrolls.

🔗 Smooth Navigation — Clicking navigation links smoothly scrolls to the corresponding section.

💻 Clean & Modern UI — Simple, professional, and user-friendly interface.
...
CSS3	Styling, animations, responsiveness, and layout
